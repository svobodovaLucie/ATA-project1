...
Patch version created by: Lucie Svobodová, xsvobo1x@stud.fit.vutbr.cz
"""
import enum
import sched
import collections
    ...
    def check_dead_requests(self):
        ...
        for cargo_req in self.requests:
            ...
            if cargo_req.prio == True and wait_time >= 120:
                self.requests.remove(cargo_req)
                raise PrioRequestTimeout    # PATCH: an exception is raised if the request waits too long
